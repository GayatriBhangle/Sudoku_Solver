...
public class Sudoku extends JFrame {
	...
	private void initComponents() {
		...
		// Set the button text color to blue
				btnClear.setForeground(Color.BLUE);
				btnSolve.setForeground(Color.BLUE);
				btnRevert.setForeground(Color.BLUE);
	...
	public void setCellValue(int row, int col, int value, boolean isUserInput) {
        ...
        if (isUserInput) {
            ...
            cell.setForeground(new Color(173, 216, 230)); // Light blue color
            cell.setFont(plain);
        }
    }
